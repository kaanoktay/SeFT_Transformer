"""Module containing the PhysioNet/computing in cardiology challenge 2012."""
...
class Physionet2012DataReader(Sequence):
    ...
    def __init__(self, data_paths, endpoint_file):
        ...
        Args:
            data_path: Path containing the patient records.
    ...
    def _read_file(self, record_id):
        ...
        # Sometimes the same value is observed twice for the same time,
